...
import { handleSellingEnquiry, handleWhatsappEnquiry } from "../../utils";

export const Footer = () => {
    return <div className="w-full px-4 sm:px-20 py-3 bg-blue-100 flex flex-col sm:flex-row items-start justify-between gap-x-2 rounded-2xl sm:rounded-none">
        ...
        <div className="flex flex-col items-start justify-start gap-y-2 mt-4 sm:mt-0">
        ...
        <div className="flex flex-col items-start justify-start gap-y-2 mt-4 sm:mt-0">
            ...
            <div className="flex gap-x-2 items-center">
                <Mail size={16} /> <a href="mailto:sriganeshautocarsudupi@gmail.com">sriganeshautocarsudupi@gmail.com</a>
            </div>
            <div className="flex gap-x-2 items-center">
                <Phone size={16} /> <a href="tel:+918197560437">+918197560437</a>
            </div>
