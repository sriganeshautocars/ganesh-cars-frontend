...
export const ContactUs = () => {
    ...
    return (
        <div ref={ref} className={`w-full mt-4 mb-3 sm:mb-0 transform transition-all duration-700 ease-out ${inView ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}>
