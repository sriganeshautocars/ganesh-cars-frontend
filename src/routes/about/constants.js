export const ABOUT_US_CONTENT = [
    {
      ...
      Our dealership is known for offering clean, well-maintained cars with verified backgrounds. 
    ...
    },
    {
      ...
      With over 90 pre-owned cars available at any time — including trusted models from Maruti Suzuki, Hyundai, Tata, Toyota, Mahindra, and more — 
      we provide choices for every type of buyer, whether you're looking for fuel efficiency, family comfort, SUV capability, or budget-friendly options.<br/>
    ...
    },
    {
      ...
      With nearly three decades of industry expertise, we simplify every step of the buying process — from car selection and price clarity to documentation and delivery. 
      We aim to make your journey memorable, smooth, and stress-free.<br/>
